...
mixin _$RealtimeAudioState {
 ...
 bool get isPlaying; bool get isPaused; bool get isMicEnabled;//
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,isPlaying,isPaused,isMicEnabled,duration,durationTotal,chunkCount);

@override
String toString() {
  return 'RealtimeAudioState(isPlaying: $isPlaying, isPaused: $isPaused, isMicEnabled: $isMicEnabled, duration: $duration, durationTotal: $durationTotal, chunkCount: $chunkCount)';
}
...
@useResult
$Res call({
 bool isPlaying, bool isPaused, bool isMicEnabled, int duration, int durationTotal, int chunkCount
});
...
/// Create a copy of RealtimeAudioState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isPlaying = null,Object? isPaused = null,Object? isMicEnabled = null,Object? duration = null,Object? durationTotal = null,Object? chunkCount = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isPlaying,  bool isPaused,  bool isMicEnabled,  int duration,  int durationTotal,  int chunkCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RealtimeAudioState() when $default != null:
return $default(_that.isPlaying,_that.isPaused,_that.isMicEnabled,_that.duration,_that.durationTotal,_that.chunkCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isPlaying,  bool isPaused,  bool isMicEnabled,  int duration,  int durationTotal,  int chunkCount)  $default,) {final _that = this;
switch (_that) {
case _RealtimeAudioState():
return $default(_that.isPlaying,_that.isPaused,_that.isMicEnabled,_that.duration,_that.durationTotal,_that.chunkCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isPlaying,  bool isPaused,  bool isMicEnabled,  int duration,  int durationTotal,  int chunkCount)?  $default,) {final _that = this;
switch (_that) {
case _RealtimeAudioState() when $default != null:
return $default(_that.isPlaying,_that.isPaused,_that.isMicEnabled,_that.duration,_that.durationTotal,_that.chunkCount);case _:
  return null;
...
class _RealtimeAudioState implements RealtimeAudioState {
  const _RealtimeAudioState({this.isPlaying = false, this.isPaused = false, this.isMicEnabled = false, this.duration = 0, this.durationTotal = 0, this.chunkCount = 0});
...
/// Create a copy of RealtimeAudioState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isPlaying = null,Object? isPaused = null,Object? isMicEnabled = null,Object? duration = null,Object? durationTotal = null,Object? chunkCount = null,}) {
